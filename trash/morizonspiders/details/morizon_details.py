...
#             # Pobieranie linków do zdjęć z atrybutu data-image, tylko jeśli nie jest pusty
#             data_image_urls = response.xpath('//ul[contains(@class, "box-gallery")]/li[contains(@class, "emptyImage") and contains(@class, "state--fit-type--fill")][@data-image!=""]/@data-image').extract()

#             # Usunięcie duplikatów
#             unique_image_urls = list(set(data_image_urls))

#             # Dodanie pobranych URLi do danych ogłoszenia
#             ad_data['original_image_urls'] = unique_image_urls

#             # Logowanie dla debugowania
#             self.logger.info(f"Extracted {len(unique_image_urls)} image URLs: {unique_image_urls}")
