...
# class OtodomDomySpider(scrapy.Spider):
#     name = 'lento_urls'
#     allowed_domains = ['otodom.pl']
#     start_urls = ['https://www.otodom.pl/pl/oferty/sprzedaz/dom?limit=72']
...
#         super(OtodomDomySpider, self).__init__(*args, **kwargs)
...
#         next_page_url = f"https://www.otodom.pl/pl/oferty/sprzedaz/dom?limit=72&page={next_page}"
