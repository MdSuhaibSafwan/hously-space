...
class OtodomDetailSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'CONCURRENT_REQUESTS': 24,  # Zwiększenie liczby równoległych żądań
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ads = list(ListingOtodom.objects.filter(Q(isActive=True) | Q(isActive__isnull=True)).order_by('id'))
