...
class OtodomKawalerkiSpider(scrapy.Spider):
    name = 'otodom_kawalerki'
    allowed_domains = ['otodom.pl']
    start_urls = ['https://www.otodom.pl/pl/oferty/sprzedaz/kawalerka?limit=72']
    ...
    def __init__(self, *args, **kwargs):
        super(OtodomKawalerkiSpider, self).__init__(*args, **kwargs)
    ...
    def parse(self, response):
        ...
        for article in articles:
            ...
            if link:
                ...
                self.logger.debug(f"Scraped link URL: {item['url']}")  # Zmniejszenie poziomu logowania
                yield item
        ...
        next_page_url = f"https://www.otodom.pl/pl/oferty/sprzedaz/kawalerka?limit=72&page={next_page}"
